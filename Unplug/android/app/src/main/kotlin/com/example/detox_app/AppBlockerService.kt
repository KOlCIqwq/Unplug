    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        try {
            ...
            if (event.eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) {
                ...
                // Verify the true active window hierarchy. Sub-packages (like Facebook Messenger within Instagram)
                // trigger window state changes with different package names. Checking the root window confirms the actual host app.
